...
export const navMenus: Record<Role, MenuGroup[]> = {
  '财务负责人': [
    ...
    },
    {
      label: '人力资源管理',
      items: [
        { viewId: 'hr-manage', label: '人力资源管理中台' },
        ...
        { viewId: 'hr-overview', label: 'HR管理总览' },
      ],
    },
  ],
  '财务专员': [
...
export const viewPermissions: Record<ViewId, Role[]> = {
  ...
  'hz-settings': ['财务负责人'],
  // HR module
  'hr-overview': ['HR负责人', '财务负责人'],
  'hr-org': ['HR负责人', '财务负责人'],
  'hr-staff': ['HR负责人', '财务负责人'],
  'hr-attendance': ['HR负责人', '财务负责人'],
  'hr-payroll': ['HR负责人', '财务负责人'],
  'hr-recruit': ['HR负责人', '财务负责人'],
  'hr-perf': ['HR负责人', '财务负责人'],
  'hr-manage': ['HR负责人', '财务负责人'],
};
